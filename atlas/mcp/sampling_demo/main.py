...
async def summarize_text(text: str, summary: str | None = None) -> str:
    """Use caller-provided ``summary`` text or return a deterministic fallback."""
...
async def analyze_sentiment(text: str, analysis: str | None = None) -> str:
    """Use caller-provided ``analysis`` text or a simple keyword-based fallback."""
...
async def generate_code(description: str, language: str, generated_code: str | None = None) -> str:
    """Use caller-provided ``generated_code`` or return a minimal starter snippet."""
    fallback = (
...
async def creative_story(prompt: str, story: str | None = None) -> str:
    """Use caller-provided ``story`` text or return a short deterministic fallback."""
    fallback = (
...
async def multi_turn_conversation(
    ...
    """Use optional caller-provided responses or return deterministic fallback turns."""
...
async def research_question(
    ...
    """Use optional caller-provided ``breakdown``/``answer`` or fallback placeholders."""
...
async def translate_and_explain(
    ...
    """Use optional caller-provided translation fields or deterministic placeholders."""
