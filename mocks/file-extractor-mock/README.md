...
Update your `config/defaults/file-extractors.json` (or your overrides directory) to use this mock service:
...
3. Create `config/defaults/file-extractors.json` (or your overrides file) with the configuration above
