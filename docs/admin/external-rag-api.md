...
2. Configure your RAG sources in `config/defaults/rag-sources.json` (or in an overrides directory set via `APP_CONFIG_OVERRIDES`):
...
1. Optional overrides directory (set `APP_CONFIG_OVERRIDES`)
