...
- `getting-started/`: Onboarding and quickstart guides for setting up and running the system locally or in common environments.
- `planning/`: Roadmaps, planning notes, and internal design discussions that track feature ideas and longer-term work.
