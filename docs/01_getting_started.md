...
With the application running, you can now explore its features. For more detailed information on configuration and administration, refer to the **Admin Guide**. If you plan to contribute, the **Developer Guide** provides in-depth architectural details.
