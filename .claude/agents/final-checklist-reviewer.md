...
- [ ] OPSEC: No LLM model names, provider names, or AI tool branding in commit messages, PR descriptions, issue comments, code comments, or changelogs (e.g., no "Co-Authored-By: Claude", "Generated by GPT-4", "Copilot suggestion")
