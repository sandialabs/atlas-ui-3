...
This module provides encrypted storage for OAuth tokens and JWTs associated
with MCP servers on a per-user basis. Each user's tokens are isolated and
...
class StoredToken:
    ...
    token_type: str  # "bearer", "oauth_access", "oauth_refresh", "jwt"
