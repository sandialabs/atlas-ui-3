    ...
    <header className="flex items-center justify-between p-2 sm:p-4 bg-gray-800 border-b border-gray-700">
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        <div className="relative">
          ...
          {dropdownOpen && (
            <div className="absolute right-0 top-full mt-1 w-72 bg-gray-800 border border-gray-600 rounded-lg shadow-lg z-50 max-h-96 overflow-y-auto">
              {models.length === 0 ? (
                      ...
                      >
                        <div className="flex items-center">
                          ...
                          <button
                            ...
                            className={`px-2 py-2 hover:bg-gray-700 transition-colors rounded-r-lg ${isExpanded ? 'text-blue-400' : 'text-gray-500 hover:text-gray-300'}`}
                            title="Model details"
                          >
                        ...
                        {isExpanded && (
                          <div className="px-3 pb-2 text-xs space-y-1.5 bg-gray-750 border-t border-gray-700">
                            {model.description && (
                              <p className="text-gray-400 pt-1.5">{model.description}</p>
                            )}
                            <div className="flex flex-wrap gap-1.5 pt-1">
                              <span className={`inline-flex items-center gap-1 px-1.5 py-0.5 rounded ${model.supports_vision ? 'bg-green-900/40 text-green-400' : 'bg-gray-700 text-gray-500'}`}>
                                <Eye className="w-3 h-3" />
                                Vision
                              </span>
                              <span className={`inline-flex items-center gap-1 px-1.5 py-0.5 rounded ${model.supports_tools !== false ? 'bg-blue-900/40 text-blue-400' : 'bg-gray-700 text-gray-500'}`}>
                                <Wrench className="w-3 h-3" />
                                Tools
                              </span>
                              {complianceEnabled && model.compliance_level && (
                                <span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded bg-blue-600 text-white">
