...
- Switched `Dockerfile.runtimeonly` base images from UBI9 (`ubi9/ubi`, `ubi9/python-311`) to Chainguard (`cgr.dev/chainguard/node:20`, `cgr.dev/chainguard/python:3.11`) to reduce the CVE surface reported by grype.
