...
- Tool descriptions and input schemas from a server that gates `tools/list` are no longer handed to other users' model context: `get_tools_schema` takes the requesting user and omits catalogues that are not theirs to read.
