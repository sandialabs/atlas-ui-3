...
### PR #637 - 2026-06-09
- **Vision uploads**: TIFF files (`.tif`/`.tiff`) are accepted as image uploads and converted to PNG before being embedded in LLM vision requests, including high-precision grayscale TIFFs.
