...
### 2025-12-15
- Add Quay.io container registry CI/CD workflow for automated container publishing
- Add comprehensive Quay.io setup documentation with robot account configuration
