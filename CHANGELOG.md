...
### PR #720 - 2026-07-10
- **LLM group restrictions**: Added optional `groups` on LLM model config, filtered group-restricted models from config/auth responses, and rejected direct chat requests for models outside the user's groups.
